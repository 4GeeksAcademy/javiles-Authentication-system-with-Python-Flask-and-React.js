            ...
            <div className="card-body text-center">
                ...
                <form noValidate onSubmit={handleSignUp}>
                    ...
                    <div className="mb-3 text-start">
                        ...
                        {!validEmail && <div className="alert alert-danger mt-2 p-2">Formato de Email inválido, favor de verificar</div>}
                    </div>
                    ...
                    <div className="mb-3 text-start">
                        ...
                        {!validPassword 
                            ? <div className="alert alert-danger mt-2 p-2">Password debe ser mayor de 6 caracteres y contener letras y números</div> 
                            : <div className="alert alert-info mt-2 p-2">Mayor de 6 caracteres incluyendo letras y números</div>}
                    </div>
    
                    <div className="mb-3 text-start">
                        <label htmlFor="confirmPassword" className="form-label fw-bold">Confirma tu Password</label>
                        <input type="password" className="form-control" id="confirmPassword" />
                        {!validPswConf && <div className="alert alert-danger mt-2 p-2">Passwords no coinciden, intenta de nuevo</div>}
                    </div>
