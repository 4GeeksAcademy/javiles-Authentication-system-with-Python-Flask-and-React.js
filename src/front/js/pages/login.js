...
<div className="container d-flex justify-content-center align-items-center vh-100">
    <div className="card shadow p-4" style={{ maxWidth: "400px", width: "100%" }}>
        <div className="card-body text-center">
            ...
            <p className="text-muted">Ingresa tu email y password</p>
            
            <form noValidate onSubmit={handleLogin}>
                <div className="mb-3 text-start">
                    <label htmlFor="email" className="form-label fw-bold">Email</label>
                    <input type="email" className="form-control" id="email" />
                    {!validEmail && <div className="alert alert-danger mt-2 p-2">Email inválido, favor de verificar</div>}
                </div>
            ...
            {!validUser && <div className="alert alert-danger mt-3">Email o password inválido, favor de verificar</div>}
